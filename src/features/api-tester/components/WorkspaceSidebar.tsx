...
import { Terminal, Plus, ChevronLeft, Beaker, Sliders, History } from 'lucide-react';
        ...
        {[
          ...
          return (
            <button 
              ...
              className={cn(
                "w-full flex items-center gap-3.5 px-3 py-2.5 rounded-lg text-[11px] font-bold transition-all group cursor-pointer border-none shadow-none text-left",
                isActive 
